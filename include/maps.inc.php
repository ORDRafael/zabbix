...
/* 
REVISAR ANTES DE ESTE BLOQUE
CAMBIAR PERMISOLOGIA PARA QUE EL ROL 
AUNQUE NO TENGA PERMISO, PUEDA VER ELE ARCHIVO
	 */
	// Prepare hosts data.
...
function getMapLabels($map, $map_info) {
	...
	foreach ($selements as $selementId => $selement) {
		//* QUITAR PERMISOS PARA MOSTRAR EL LABEL
		//if ($selement['permission'] < PERM_READ) {
		//	continue;
		//}
		//EL PROXIMO IF ANTES ERA UN ELSEIF
